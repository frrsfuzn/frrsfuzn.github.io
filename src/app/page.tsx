      ...
      <div className="lg:flex lg:justify-between lg:gap-12 min-lg:px-5"> 
        ...
        <main className="lg:w-3/5 lg:pt-20 max-lg:px-10">
          <Section id="about" >
            ...
            <p>
              Hi! I&apos;m Farras! A dedicated Software Engineer with a keen interest and expertise in Frontend Technologies. Proficient in utilizing a range of tools and frameworks, including ReactJS, React Native, NextJS, JavaScript, TypeScript, ReasonML, GraphQL, Redux, and CSS.
            </p>
          </Section>
